...
export default function CombosPage() {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:px-0">
      ...
      {/* Model Masking */}
      <ModelMasksSection activeProviders={activeProviders} />
...
function ModelMasksSection({ activeProviders }) {
                ...
                <div className="flex items-center gap-2">
                  ...
                  {data.targetModel && (
                    <span className="text-xs text-text-muted flex items-center gap-1">
                      ...
                      <code className="font-mono">{data.targetModel}</code>
                    </span>
                  )}
                </div>
                {data.systemPrompt && (
          ...
          <form onSubmit={handleSave} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button type="button" variant="secondary" onClick={() => setShowModelSelect(true)}>
                  Select
                </Button>
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-lg border border-black/10 dark:border-white/10 bg-surface p-2.5 text-xs text-text-main focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
              />
